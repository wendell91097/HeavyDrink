...
Revision ID: d4a9c5be02e4
Revises: 
Create Date: 2023-03-17 14:57:14.086056
...
def upgrade():
    ...
    sa.Column('proof', sa.String(length=200), nullable=False),
    sa.Column('origin', sa.String(length=200), nullable=False),
    sa.Column('vintage', sa.String(length=200), nullable=True),
